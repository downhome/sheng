describe Sheng::CheckBox do
  subject { described_class.new(xml_fragment('input/check_box/check_box')) }
  ...
  describe '#interpolate' do
    ...
    it "checks the checkbox if key is truthy in dataset" do
      ...
      expect(subject.element).to be_equivalent_to xml_fragment('output/check_box/check_box')
    end
    ...
    it "does not uncheck a default checked checkbox if key is truthy in dataset" do
      ...
      expect(default_checked.element).to be_equivalent_to xml_fragment('output/check_box/check_box')
    end
